...
public class EmailGenratorService {
    ...
    private final WebClient webClientl;
    ...
    public EmailGenratorService(WebClient.Builder webClientBuilder) {
        this.webClientl = WebClient.builder().build();
    }
    ...
    * */
    ...
    public String genratEmailReply(EmailRequest emailRequest) {
        ...
        // Do request and get response
        String response = webClientl.post()
